export default {
  ...
  onboarding: {
    ...
    lmpDate: 'When was the first day of your last menstrual period?',
    naegeleTooltip: "Naegele's Rule is a standard way to calculate your due date. It assumes a 28-day cycle and that ovulation occurs on day 14.",
    selectDate: 'Select date',
    estimatedDueDate: 'Estimated Due Date:',
    acceptDate: 'Accept this date',
    adjustDate: 'Adjust date',
    enterDateFormat: 'Enter date in DD/MM/YYYY format',
    continue: 'Continue',
    finish: 'Finish',
  },
  calendar: {
    week: 'Week',
    weekShort: 'WK',
    weeklyUpdate: 'Your Weekly Update'
  },
  baby: {
    greeting: 'Hi',
    dueDate: 'Due'
  ...
  momFeatures: {
    bloodTest: {
      ...
      upload: {
        ...
        analyzeButton: 'Analyze Results',
        changeFile: 'Change File',
        tips: {
          image: 'Make sure the image is clear',
          document: 'Make sure that the pdf is not locked with password',
          text: 'Make sure the text is clear'
        }
      },
      analysis: {
        title: 'Blood Test Analysis',
        newAnalysis: 'New Analysis',
        noIssues: 'No issues found in your blood test results.',
        disclaimer: 'This analysis is powered by AI and should not replace professional medical advice. Always consult with your healthcare provider about your test results.'
      }
    },
    kickCounter: {
      title: 'Kick\nCounter',
      ...
      badge: 'Track',
      modalTitle: 'Kick Counter',
      reset: 'Reset',
      kicks: 'kicks',
      save: 'Save Session',
      saving: 'Saving...',
      babyKicked: 'Baby Kicked!',
      activeMessage: 'Your baby is very active, that\'s a good sign!',
      statics: 'See your baby stats!'
    },
    screen: {
      title: "Mom's Health",
      subtitle: 'Track your well-being during pregnancy'
    },
    contractionTracker: {
      title: 'Contraction\nTracker',
